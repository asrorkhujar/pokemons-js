...
for (let pokemon of pokemons) {
  ...
  //SET ATTRIBUTE
  newItemPokemon.setAttribute('class', 'pokemons__item col-sm-6 col-md-3 mb-4');
  ...
  newCardContentWrapper.setAttribute('class', 'd-flex justify-content-between');
  ...
  newCardAge.textContent = `${pokemon.candy_count} age`;
  ...
  newCardContentWrapper.appendChild(newHeartImg);
